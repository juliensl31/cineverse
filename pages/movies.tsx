          ...
          <div className="mb-8 py-4">
            ...
            <div className="flex justify-center gap-4">
              ...
              <select
                ...
                className={`px-4 py-2 rounded-xl bg-white/10 text-white ${selectedGenre ? 'btn-gradient' : ''
                  }`}
              >
              ...
              <select
                ...
                className={`px-4 py-2 rounded-xl bg-white/10 text-white ${selectedYear ? 'btn-gradient' : ''
                  }`}
              >
